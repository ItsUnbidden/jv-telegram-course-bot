...
public class GeneralBanMenu implements MenuConfigurer {
    ...
    public Menu configure() {
        ...
        page1.setButtonsFunction(p -> List.of(
            new TransitoryButton(loader.localize(Localizations.Button.GIVE_BAN, p.user()).getData(), 1),
            new TransitoryButton(loader.localize(Localizations.Button.LIFT_BAN, p.user()).getData(), 1)));
...
;
        ...
        page2.setButtonsFunction(p -> List.of(
            new TerminalButton(loader.localize(Localizations.Button.BY_ID, p.user()).getData(), generalBanHandler),
            new TerminalButton(loader.localize(Localizations.Button.CHOOSE_USER, p.user()).getData(), generalBanHandler),
