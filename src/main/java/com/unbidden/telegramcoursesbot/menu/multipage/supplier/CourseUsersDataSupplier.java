...
@Component 
public class CourseUsersDataSupplier extends AbstractTableDataSupplier {
    ...
    public CourseUsersDataSupplier(LocalizationLoader loader, ContentOrchestrationService contentService,
    ...
    public MultipageListData fetchData(BotRole botRole, int page, Map<String, String> params) {
        ...
        final Page<UserEntity> users = userRepository.findByActiveCourseOwnership(courseId, PageRequest.of(page, PAGE_SIZE));
        final RichText text = new RichTextPlain(loader.localize(Localizations.Menu.MULTIPAGE_LIST_COURSE_USERS, botRole,
                new Localizations.Menu.MultipageListCourseUsersParams(contentService.getLocalizedText(
