...
public class HomeworkInclusionButtonHandler extends AbstractButtonHandler {
    ...
    public void handle(UserEntity user, Bot bot, Map<String, String> params) {
        courseService.toggleHomeworkInclusion(user, bot, Long.parseLong(params.get(COURSE_ID_PARAM)));   
    }
}
