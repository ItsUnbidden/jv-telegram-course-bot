...
public class ReviewService {
    ...
    @Transactional
    public Review upgradeReview(UserEntity user, Bot bot, Long courseId, List<Message> messages) {
        Assert.notNull(user, "user cannot be null");
        Assert.notNull(bot, "bot cannot be null");
        Assert.notNull(courseId, "courseId cannot be null");
        Assert.notNull(messages, "messages cannot be null");

        final Review review = entityUtil.getReviewByCourseAndUser(user, bot, courseId);
    ...
    public Review updateComment(UserEntity user, Bot bot, Long reviewId, List<Message> messages) {
        ...
        final Review review = checkReviewForComment(user, bot, reviewId);
        
        LOGGER.info("User " + user.getId() + " wants to update comment in review " + review.getId() + ".");
