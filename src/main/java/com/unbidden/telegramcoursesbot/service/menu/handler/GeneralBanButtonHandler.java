...
public class GeneralBanButtonHandler implements ButtonHandler {
private static final Logger LOGGER = LogManager.getLogger(GeneralBanButtonHandler.class);
    ...
    private static final String SERVICE_GENERAL_BAN_LIFTED_SUCCESS = "service_general_ban_lifted_success";
    private static final String SERVICE_GENERAL_BAN_SUCCESS = "service_general_ban_success";
        ...
        switch (params[1]) {
            case CHOOSE_USER:
                ...
                final KeyboardButtonRequestUser requestUser = KeyboardButtonRequestUser.builder()
                        ...
                        .requestId(String.valueOf(userOrChatRequestSessionService
                            .createSession(user, bot, getBanFunction(user, bot, !params[0]
            ...
            default:
                ...
                contentSessionService.createSession(user, bot, m -> {
                    textUtil.checkExpectedMessages((params[0].equals(GIVE_BAN))
