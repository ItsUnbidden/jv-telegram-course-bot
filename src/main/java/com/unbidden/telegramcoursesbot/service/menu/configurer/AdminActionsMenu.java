...
public class AdminActionsMenu implements MenuConfigurer {
    ...
    public Menu configure() {
        ...
        page1.setLocalizationFunction((u, p, b) -> loader.localize(
            Localizations.Menu.ADMIN_ACTIONS_PAGE_0, u));
        page1.setButtonsFunction((u, p, b) -> List.of(new TransitoryButton(
                loader.localize(Localizations.Button.ADD_OR_REMOVE_ADMIN, u)
                    .getData(), SET_ROLE, 1), new TerminalButton(
                loader.localize(Localizations.Button.LIST_ADMINS, u)
                    .getData(), LIST_ADMINS, listAdminsHandler), new TerminalButton(
                loader.localize(Localizations.Button.TOGGLE_RECEIVE_HOMEWORK, u)
                    .getData(), TOGGLE_RECEIVE_HOMEWORK, receiveHomeworkHandler),
                new TransitoryButton(loader.localize(
                    Localizations.Button.BAN_OPTIONS, u).getData(), BAN, 2)));
        final Page page2 = new Page(adminActionsMenu);

        page2.setPageIndex(1);
        page2.setPreviousPage(0);
        page2.setButtonsRowSize(2);
        page2.setLocalizationFunction((u, p, b) -> loader.localize(
            Localizations.Menu.ADMIN_ACTIONS_PAGE_1, u));
        page2.setButtonsFunction((u, p, b) -> {
            ...
            buttons.add(new BackwardButton(loader.localize(Localizations.Button.BACK,
                    u).getData()));
            return buttons;
        });
        ...
        page3.setLocalizationFunction((u, p, b) -> loader.localize(
            Localizations.Menu.ADMIN_ACTIONS_PAGE_2, u));
        page3.setButtonsFunction((u, p, b) -> List.of(new TransitoryButton(loader
                .localize(Localizations.Button.GIVE_BAN, u).getData(), GIVE_BAN, 3),
                new TransitoryButton(loader.localize(Localizations.Button.LIFT_BAN, u)
                .getData(), LIFT_BAN, 3), new BackwardButton(loader
                .localize(Localizations.Button.BACK, u).getData())));
        final Page page4 = new Page(adminActionsMenu);

        page4.setPageIndex(3);
        page4.setPreviousPage(2);
        page4.setButtonsRowSize(2);
        page4.setLocalizationFunction((u, p, b) -> loader.localize(
            Localizations.Menu.ADMIN_ACTIONS_PAGE_3, u));
        page4.setButtonsFunction((u, p, b) -> List.of(new TerminalButton(loader
                .localize(Localizations.Button.BY_ID, u).getData(), BY_ID, banHandler),
                new TerminalButton(loader.localize(
                Localizations.Button.CHOOSE_USER, u).getData(), CHOOSE_USER, banHandler),
                new BackwardButton(loader.localize(Localizations.Button.BACK, u)
                .getData())));
